            ...
            <Grid sx={{ margin: "1rem" }}>
              <Row style={{ marginBottom: "1rem" }}>
                ...
                <Col>
                  ...
                  <FMTypography
                    displayText={moment(
                      getCategoryBannerDetails?.createdAt
                    ).format("DD/MM/YYYY")}
                    styleData={{ color: "#717171" }}
                  />
                </Col>
              ...
              <Row style={{ marginBottom: "1rem" }}>
                ...
                <Col>
                  ...
                  <FMTypography
                    displayText={
                      getCategoryBannerDetails?.bannerImageTextAltText
                    }
                    styleData={{ color: "#717171" }}
                  />
                </Col>
              ...
              <Row style={{ marginBottom: "1rem" }}>
                <Col>
                  <FMTypography displayText={"Button Text"} />
                  <FMTypography
                    displayText={getCategoryBannerDetails?.buttonText}
                    styleData={{ color: "#717171" }}
                  />
                </Col>
              </Row>
