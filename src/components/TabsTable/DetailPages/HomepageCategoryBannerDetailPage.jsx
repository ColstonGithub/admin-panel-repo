          ...
          >
            ...
            >
              <Col className="col-11">
                <FMTypography
                  displayText={"Homepage Explore Category Details"}
                  styleData={{
                    fontWeight: "500",
                    fontSize: "1.125rem",
            ...
            <Grid sx={{ margin: "1rem" }}>
              <Row style={{ marginBottom: "1rem" }}>
                <Col>
                  ...
                  <FMTypography
                    displayText={moment(
                      homepageExploreCatDetail?.createdAt
                    ).format("DD/MM/YYYY")}
                ...
                <Col>
                  ...
                  <FMTypography
                    displayText={homepageExploreCatDetail?.imageTitle}
                    styleData={{ color: "#717171" }}
                  />
                </Col>
              </Row>
              ...
              <Row>
                ...
                <Col>
                  <img
                    src={homepageExploreCatDetail?.image}
                    alt="img"
                    width="450px"
                    height="auto"
