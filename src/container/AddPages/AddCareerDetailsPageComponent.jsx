...
const AddCareerDetailsPageComponent = (props) => {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(addCareerDetails(formData)).then(() => {
...
export default AddCareerDetailsPageComponent;
